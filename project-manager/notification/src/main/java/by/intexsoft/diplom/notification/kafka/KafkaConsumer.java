...
public class KafkaConsumer {
        ...
        @KafkaListener(topics = "${spring.kafka.topic-auth.name}", groupId = "verify-group")
        ...
        @KafkaListener(topics = "${spring.kafka.topic-verify.name}", groupId = "verify-group")
        ...
        @KafkaListener(topics = "${spring.kafka.topic-participation.name}", groupId = "participation-group")
        public void listenParticipationAnswerMessage(KafkaMessageModel messageModelDto){
                emailSenderServices.sendEmail(messageModelDto.getToEmail(),
                        "Answer!",
                        messageModelDto.getVerificationCode());
                log.info("Message sent to email: {}", messageModelDto.getToEmail());
